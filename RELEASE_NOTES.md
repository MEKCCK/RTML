...
- **BMCLAPI 镜像加速** — 国内用户友好
- **桌面快捷方式** — Linux .desktop / macOS .command / Windows VBS
...
- Windows exe: `scripts/rtml-1.0.0-2-x86_64.exe` (11M)
- Linux 二进制(备用): `scripts/rtml-linux-x86_64` (12M)
