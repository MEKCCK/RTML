...
impl ContentTab {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ContentTab::Mods => "模组",
            ContentTab::ResourcePacks => "资源包",
            ContentTab::Shaders => "光影",
            ContentTab::Screenshots => "截图",
            ContentTab::Worlds => "存档",
            ContentTab::Logs => "日志",
        }
    }
...
pub fn title(
    ...
    match instance {
        ...
        Some(inst) => {
            ...
            let run_state = crate::instance::running::get(&inst.name);
